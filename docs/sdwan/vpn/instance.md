...
VPN instance configuration is performed entirely through the mfusion Orchestrator GUI. The following configuration example illustrate the mfusion GUI setting for a **Spoke-to-Spoke (L3)** deployment using **VXLAN over WireGuard with BGP** (instance ID `10`)
