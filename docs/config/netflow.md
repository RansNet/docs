...
Explain netflow, how it works and the general use case.

All RansNet SD-WAN routers support export network traffic statistics to netflow collector for reporting.
